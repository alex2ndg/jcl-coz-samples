...
//* %%SET %%FILE=test_file.csv   File to be retrieved
//* %%SET %%ZFILE=ORG.TEST.FILE.CSV.TORETR   File to be retrieved
//*
...
//*   localf for Unix local file to share. to start always with //
//*   localf for zOS local file to save. to start always with //
